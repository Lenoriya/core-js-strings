 ...
 *   getFirstChar('') => ''
 */
function getFirstChar(/* value */ value) {
  // throw new Error('Not implemented');
 ...
 */
function removeLeadingAndTrailingWhitespaces(/* value */ value) {
  // throw new Error('Not implemented');
 ...
 */
function removeLeadingWhitespaces(/* value */ value) {
  // throw new Error('Not implemented');
 ...
 */
function removeTrailingWhitespaces(/* value */ value) {
  // throw new Error('Not implemented');
 ...
 *   repeatString('abc', -2) => ''
 */
function repeatString(/* str, times */ str, times) {
  // throw new Error('Not implemented');
  let rep;
  if (times > 0) {
    rep = str.repeat(times);
  } else rep = '';
  return rep;
}
 ...
 */
function removeFirstOccurrences(/* str, value */ str, value) {
  // throw new Error('Not implemented');
 ...
 */
function removeLastOccurrences(/* str, value */ str, value) {
  // throw new Error('Not implemented');
 ...
 */
function startsWith(/* str, substr */ str, substr) {
  // throw new Error('Not implemented');
 ...
 */
function endsWith(/* str, substr */ str, substr) {
  // throw new Error('Not implemented');
 ...
 */
function reverseString(/* str */ str) {
  // throw new Error('Not implemented');
 ...
 */
function orderAlphabetically(/* str */ str) {
  // throw new Error('Not implemented');
 ...
 */
function containsSubstring(/* str, substring */ str, substring) {
  // throw new Error('Not implemented');
...
function isPalindrome(/* str */ str) {
  // throw new Error('Not implemented');
  const strNew = str.replace(/[^A-Z0-9]/gi, '').toLowerCase();
  const strPal = strNew.split('').reverse().join('');
  if (strNew === strPal) {
    return true;
  }
  return false;
 ...
 */
function findLongestWord(/* sentence */ sentence) {
  // throw new Error('Not implemented');
  let word = '';
 ...
 */
function getStringFromTemplate(/* firstName, lastName */ firstName, lastName) {
  // throw new Error('Not implemented');
 ...
 */
function extractEmails(/* str */ str) {
  // throw new Error('Not implemented');
